...
<p align="center">
  <code>v0.1.0</code> · проекты на любом стеке · CLI: Python 3.10+ · 118 автотестов
</p>
...
Текущий набор содержит 118 автоматических тестов: установка и обновление, граф, rollback, checksum drift, повреждённая конфигурация, опасные сторонние скиллы, delivery evidence, remote-gate preflight, типизированные model и effort, матрица эффективной конфигурации, миграция `config normalize` и `graph --migrate`, гейт review-артефактов, нейтральность публичного шаблона, правило декомпозиции задач, runbook подготовки GitHub, принудительный бюджет циклов и установка пользовательского скилла.
